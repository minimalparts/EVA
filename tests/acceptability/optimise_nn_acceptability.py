...
logger = JSONLogger(path="fasttext.optimisation_logs.r1.json")

# Bounded region of parameter space
pbounds = {'hiddensize': (100, 300), 'lrate': (0.001, 0.01), 'wdecay': (0.001,0.01), 'batchsize': (16,1024), 'epochs': (100,500)}
...
external_vector_file = "acceptability/models/acceptability_fasttext_vecs.txt"
