...
Usage:
  compatibility.py --lr=<n> --batch=<n> --epochs=<n> --hidden=<n> --wdecay=<n> [--ext=<file>] [--att] [--rel] [--ppmi]
...
def train_model(words1_train,words2_train,scores_train,words1_val,words2_val,scores_val,ids_train,ids_val,hiddensize,lrate,wdecay,batchsize,epochs):
    '''Initialise network'''
    ...
    for epoch in range(epochs):
        ...
        validation_scores.append(validate(net,ids_val,words1_val,words2_val,scores_val)[0])
...
if __name__ == '__main__':
    ...
    train_model(words1_train.shape[1],scores_train.shape[1],hiddensize,lrate,wdecay,batchsize,epochs)
